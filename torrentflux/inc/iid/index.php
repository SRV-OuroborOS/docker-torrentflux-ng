...
//trie du tableau par owner #nico
/*
uasort($arListTorrent, function ($a, $b) {
	if ($a['transferowner'] == $b['transferowner'] )
		return 0;
		return ( $a['transferowner'] < $b['transferowner'] ) ? -1 : 1;
});
*/
